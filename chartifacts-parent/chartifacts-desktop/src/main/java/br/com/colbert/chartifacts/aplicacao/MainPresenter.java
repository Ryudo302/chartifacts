...
public class MainPresenter extends AbstractPresenter<MainWindow> {
	...
	public void sobre() {
		...
		mostrarMensagemInformativa(
				carregarMensagemHtml(ARQUIVO_HTML_SOBRE, informacoesAplicacao.getNome().toUpperCase(), informacoesAplicacao.getVersao(),
						informacoesAplicacao.getNumeroBuild(), informacoesAplicacao.getAutor()),
